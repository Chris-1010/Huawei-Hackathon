...
import spacy
from JSON_reader import Files, DataJS
...
#     mnist = parser(--data_url).read_data_sets(FLAGS.data_url, one_hot=True)
...
questions = f.files["example-covid-vaccinations.json"]._data['questions']
